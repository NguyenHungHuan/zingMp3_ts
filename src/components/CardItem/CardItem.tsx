...
export default function CardItem({
  ...
  return (
    ...
    >
      <div className='flex items-center w-1/2 gap-[10px]'>
        {number && (
          <div className='flex items-center justify-center text-xs font-bold mr-2'>
            <span
              className={classNames(
                'min-w-[60px] text-[#4a90e200] text-[32px] font-black leading-[1] text-center mr-1',
                {
            ...
            <div className='w-[18px] h-[36px] flex flex-col justify-center items-center text-white'>
        ...
        <div className='flex flex-col break-words gap-[3px] font-medium'>
          <div className='flex items-center'>
            ...
            {dataItem.streamingStatus === 2 && (
              <i className='inline-block leading-[66%] flex-shrink-0 ml-2'>
          ...
          {dataItem.artists ? (
            <Artist
              ...
              className={classNames(
                'text-[#ffffff80] text-xs overflow-hidden text-ellipsis block line-clamp-1 whitespace-nowrap',
                {
                  'opacity-50': dataItem.streamingStatus === 2
                }
              )}
            ...
            <span className='text-[#ffffff80] text-xs overflow-hidden text-ellipsis block line-clamp-1 break-words font-normal'>
      ...
      {dataItem.album && dataItem.duration && (
        <div className='flex items-center justify-between text-xs text-[#ffffff80] w-1/2 flex-shrink-0 flex-1'>
          <Link to={'/'} className='hover:text-[#c273ed] hover:underline'>
            {dataItem.album.title}
          </Link>
          <span className='pr-2 font-normal inline-block group-hover:hidden'>
      ...
      {dataItem.mvlink && !hideMv && (
        <Tooltip text='Xem MV' className='hidden group-hover:block'>
          <button className='rounded-full hidden items-center justify-center w-[38px] h-[38px] group-hover:flex hover:bg-[#413a4a] fill-white'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
      ...
      >
        <Tooltip text='Khác'>
          <button
            onClick={handleClick}
            className='rounded-full flex invisible items-center justify-center w-[38px] h-[38px] group-hover:visible hover:bg-[#413a4a]'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
